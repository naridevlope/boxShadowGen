...
const copyCodeBtn = document.querySelector("#copy-instructions");

rulesArea.addEventListener("click", () =>{
    const rules = rulesArea.innerText.replace(/^\s*\n/gm, "");
    
    console.log(rules) // Testando pra ver se chegou nesse bloco
    navigator.clipboard.writeText(rules).then(() => {

        copyCodeBtn.innerText = " Copiado!";

        setTimeout(() => {
            copyCodeBtn.innerText = " Clique no quadro acima para copiar!";
        }, 5000)
    });
});
